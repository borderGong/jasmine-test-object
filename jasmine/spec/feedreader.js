    ...
    */
    describe('RSS Feeds', function() {
        ...
        */
         ...
         */
        it('each item in allFeeds has link & not empty', function(){
         ...
         */
        it('each item in allFeeds has name & not empty', function(){
            allFeeds.forEach(item => {
    ...
    describe('The menu', () => {
        ...
        it('should be hide in init', () => {
          ...
          * 再次点击的时候是否隐藏。
          */
        it('should be toggle when it be clicked', () => {
